 ...
 * @author David
 */
public class MezclaDirectaBooleanos {
    //Prueba p=new Prueba();
    public MezclaDirectaBooleanos() throws IOException {
        File fich = new File(Prueba.nombreArchivo);
        
        System.out.println("Ordenando Booleanos");
        System.out.println("entro "+ Prueba.nombreArchivo);
        //escribir(fich);
        mezclaDirecta(fich);
        System.out.println("Archivo Ordenado Booleanos");
