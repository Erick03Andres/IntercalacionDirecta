 ...
 * @author David
 */
public class OrdenNaturalNumeros {
   
    public OrdenNaturalNumeros() throws Exception{
        ...
        try {
            ...
            while (Archivo.readRecord()) {
                ...
                //Cambio de secuencia. Manipulacion del indice del arreglo de archivos
                    ...
                    //Integer.parseInt(anterior)>Integer.parseInt(actual)
                ...
                //System.out.println(actual+"->"+get1+"->"+get2+"->"+get3);
        ...
        try {
            ...
            while (contAux1 > 0 && contAux2 > 0) {
                ...
                if (anterior[0] == null && anterior[1] == null) {
                    ...
                    get11=Auxiliares[0].get(1);
                    get12=Auxiliares[0].get(2);
                    get13=Auxiliares[0].get(3);
                    
                    contAux1--;
                    Auxiliares[1].readRecord();
                    anterior[1] = actual[1] = Auxiliares[1].get(0);
                    get21=Auxiliares[1].get(1);
                    get22=Auxiliares[1].get(2);
                ...
                //Integer.parseInt(anterior[0]) <= Integer.parseInt(actual[0]) && Integer.parseInt(anterior[1])<=Integer.parseInt(actual[1]
          
                while (Integer.parseInt(anterior[0]) <= Integer.parseInt(actual[0]) && Integer.parseInt(anterior[1])<=Integer.parseInt(actual[1]) )
                   
                {
                     
                    //Integer.parseInt(actual[0])<=Integer.parseInt(actual[1])
