 ...
 * @author David
 */
public class OrdenamientoBalanceadoStrings {
    ...
    static final String tope="÷";
    
    public OrdenamientoBalanceadoStrings() throws FileNotFoundException {
     ...
     public static void mezclaEqMple() throws FileNotFoundException, IOException
    {
        ...
        try
        {
            ...
            while(t>1);
            System.out.println("Archivo Ordenado de Strings...");
            escribir(f[c[0]]);
    ...
    static void escribir(File f)
    {
        ...
        try
        {
            ...
            {   
                ...
                System.out.println(flujo.get(1) + " ");
               // if(k%19==0)
                   // System.out.println();
                is_end = flujo.readRecord();
