 ...
 * @author David
 */
public class OrdenamientoBalanceadoNumeros {
    ...
    static final int tope=99999999;

    
    public OrdenamientoBalanceadoNumeros() throws FileNotFoundException {
     ...
     public static void mezclaEqMple() throws FileNotFoundException, IOException
    {
        ...
        //distribucion inicial de tramos desde archivo origen 
            ...
            do
            {
                ...
                for(int n=0; n<k1; n++)
                {
                    ...
                    if(flujoEntradaActual.readRecord()){
                        ...
                        r[n]=Integer.parseInt(flujoEntradaActual.get(0));
                        get1=flujoEntradaActual.get(1);
                        get2=flujoEntradaActual.get(2);
    ...
    public static int distribuir() throws IOException
    {
        ...
        //{   
            while(flujo.readRecord())
            {
                ...
                clave=Integer.parseInt(flujo.get(0));
                get1=flujo.get(1);
                get2=flujo.get(2);
                get3=flujo.get(3);
                
                while(anterior<=clave && flujo.readRecord()==true )
                { 
                    //flujoSalida[j].writeInt(clave);
                    flujoSalida[j].write(String.valueOf(clave));
    ...
    static void escribir(File f)
    {
        ...
        try
        {
            ...
            {   
                ...
                System.out.println(flujo.get(0) + " ");
               // if(k%19==0)
                   // System.out.println();
                is_end = flujo.readRecord();
